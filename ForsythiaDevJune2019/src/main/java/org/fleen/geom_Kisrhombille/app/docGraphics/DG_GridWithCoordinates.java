...
public class DG_GridWithCoordinates
extends DocGraphics {
    @Override
    void doGraphics() {
        this.initImage(768, 512, 60.0, WHITE);
        Set<KPoint> points = this.strokeGrid(8, 4.0, GREY5);
        for (KPoint p : points) {
            this.renderPoint(p, 16.0, GREY4);
        }
        for (KPoint p : points) {
    ...
    public static final void main(String[] a) {
        new org.fleen.geom_Kisrhombille.app.docGraphics.DG_GridWithCoordinates();
    }
}
